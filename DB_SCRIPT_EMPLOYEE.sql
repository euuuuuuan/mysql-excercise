...
DROP TABLE IF EXISTS `SAL_GRADE` CASCADE;
...
INSERT INTO NATION (NATIONAL_CODE, NATIONAL_NAME)
VALUES ('KO', '한국'),
       ('JP', '일본'),
       ('CH', '중국'),
       ('US', '미국'),
